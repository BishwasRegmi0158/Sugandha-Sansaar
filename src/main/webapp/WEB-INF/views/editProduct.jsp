            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/products"
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" maxlength="150" required value="${product.name}">
                    </div>

                    <div class="form-group">
                        <label for="brand">Brand <span class="required">*</span></label>
                        <input type="text" id="brand" name="brand" maxlength="100" required value="${product.brand}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="imageUrl" name="imageUrl" maxlength="500"
                               value="${not empty product.imageUrl ? product.imageUrl : ''}">
                        <c:if test="${not empty product.imageUrl}">
                            <img src="${pageContext.request.contextPath}/static/images/${product.imageUrl}"
                                 alt="Current" class="img-preview">
                        </c:if>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="active">
                            ...
                            <option value="0" ${not product.active ? 'selected' : ''}>Inactive</option>
                        </select>
                    </div>
