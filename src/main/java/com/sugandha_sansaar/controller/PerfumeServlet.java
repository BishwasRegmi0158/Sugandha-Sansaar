...
public class PerfumeServlet extends HttpServlet {
    ...
    private Perfume buildPerfumeFromRequest(HttpServletRequest request) {
        ...
        p.setName(productValidation.sanitize(request.getParameter("name")));
        p.setBrand(productValidation.sanitize(request.getParameter("brand")));
        p.setCategory(productValidation.sanitize(request.getParameter("category")));
        p.setDescription(productValidation.sanitize(request.getParameter("description")));
        p.setImageUrl(productValidation.sanitize(request.getParameter("imageUrl")));
        p.setGender(productValidation.sanitize(request.getParameter("gender")));
